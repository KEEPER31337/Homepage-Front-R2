  ...
  return (
    ...
    >
      <rect
        ...
        fill="url(#pattern0)"
      />
      <path d="M120.084 5.53835L160.676 13.2559L131.086 45.3661L120.084 5.53835Z" fill={KEEPER_COLOR.pointBlue} />
      <path d="M198.084 10.5383L238.676 18.2559L209.086 50.3661L198.084 10.5383Z" fill={KEEPER_COLOR.pointBlue} />
      <circle cx="160" cy="43" r="5" fill={KEEPER_COLOR.pointBlue} />
      <ellipse
        ...
        fill={PUPIL_COLOR}
      />
      <circle cx="186" cy="43" r="5" fill={KEEPER_COLOR.pointBlue} />
      <ellipse
        ...
        fill={PUPIL_COLOR}
      />
      <line x1="147.062" y1="49.5039" x2="155.062" y2="50.5039" stroke={KEEPER_COLOR.pointBlue} />
      <line x1="147.929" y1="53.505" x2="154.929" y2="52.505" stroke={KEEPER_COLOR.pointBlue} />
      <line
        y1="-0.5"
        x2="8.13398"
        y2="-0.5"
        transform="matrix(-0.97294 0.231058 0.235185 0.971951 198.914 49)"
        stroke={KEEPER_COLOR.pointBlue}
      />
      <line
        y1="-0.5"
        x2="7.1375"
        ...
        stroke={KEEPER_COLOR.pointBlue}
      />
      <line x1="149.135" y1="64.0092" x2="171.135" y2="67.0092" stroke={KEEPER_COLOR.pointBlue} strokeWidth="2" />
      <line x1="175.852" y1="67.0111" x2="195.852" y2="64.0111" stroke={KEEPER_COLOR.pointBlue} strokeWidth="2" />
      <ellipse cx="173" cy="48" rx="2" ry="1" fill={KEEPER_COLOR.pointBlue} />
      <path
