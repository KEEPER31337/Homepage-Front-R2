...
import { getSeminarInfo } from '@api/seminarApi';
...
const SeminarAttend = () => {
  ...
  const recentSeminarDate = getSeminarInfo(5).data?.openTime.slice(2, 10).replaceAll('-', '.'); // TODO: 이후 최근/예정/이전 세미나 날짜 조회 api로 교체
