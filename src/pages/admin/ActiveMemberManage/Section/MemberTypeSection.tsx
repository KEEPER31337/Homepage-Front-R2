...
const MemberTypeSection = ({ memberList, selectedMemberList, setSelectedMemberList }: MemberCardProps) => {
  ...
  return (
    <div className="mb-5 grid h-[580px] grid-cols-2 content-start gap-3 overflow-y-scroll sm:grid-cols-7">
      {memberTypes.map((memberType) => (
        ...
        >
          <div className="flex items-center space-x-2 p-1">
            <div className={`${memberType.colorClassName} mr-2 h-4 w-4 rounded-full`} />
