...
const BoardSearch = () => {
  return (
    <div className="flex basis-3/5 flex-row gap-4">
      <div className="flex basis-1/6 flex-row items-center justify-between border-b border-pointBlue px-1 py-2">
        <span>제목 + 내용</span>
        <MdOutlineArrowDropDown />
      </div>
      <div className="flex basis-5/6 flex-row items-center justify-between border-b border-pointBlue px-[9px] py-2">
        <input
          type="text"
